...
std::shared_ptr<ControllerButtonMapping> ButtonMappingFactory::CreateButtonMappingFromConfig(uint8_t portIndex,
    ...
    if (mappingClass == "WiiUButtonToButtonMapping") {
        ...
        if (shipDeviceIndex < 0 || wiiuControllerButton == -1) {
        ...
        return std::make_shared<WiiUButtonToButtonMapping>(static_cast<ShipDeviceIndex>(shipDeviceIndex), portIndex,
...
ButtonMappingFactory::CreateDefaultWiiUButtonMappings(ShipDeviceIndex shipDeviceIndex, uint8_t portIndex,
                                                      CONTROLLERBUTTONS_T bitmask) {
    ...
    if (wiiuIndexMapping->IsWiiUGamepad()) {
        switch (bitmask) {
            case BTN_A:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_A, false,
                                                                               false, VPAD_BUTTON_A));
                break;
            case BTN_B:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_B, false,
                                                                               false, VPAD_BUTTON_B));
                break;
            case BTN_L:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_L, false,
                                                                               false, VPAD_BUTTON_L));
                break;
            case BTN_R:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_R, false,
                                                                               false, VPAD_BUTTON_ZR));
                break;
            case BTN_Z:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_Z, false,
                                                                               false, VPAD_BUTTON_ZL));
                break;
            case BTN_START:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_START,
                                                                               false, false, VPAD_BUTTON_PLUS));
                break;
            case BTN_CUP:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                    shipDeviceIndex, portIndex, BTN_CUP, false, false, VPAD_STICK_R_EMULATION_UP));
                break;
            case BTN_CDOWN:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                    shipDeviceIndex, portIndex, BTN_CDOWN, false, false, VPAD_STICK_R_EMULATION_DOWN));
                break;
            case BTN_CLEFT:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                    shipDeviceIndex, portIndex, BTN_CLEFT, false, false, VPAD_STICK_R_EMULATION_LEFT));
                break;
            case BTN_CRIGHT:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                    shipDeviceIndex, portIndex, BTN_CRIGHT, false, false, VPAD_STICK_R_EMULATION_RIGHT));
                break;
            case BTN_DUP:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_DUP,
                                                                               false, false, VPAD_BUTTON_UP));
                break;
            case BTN_DDOWN:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_DDOWN,
                                                                               false, false, VPAD_BUTTON_DOWN));
                break;
            case BTN_DLEFT:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_DLEFT,
                                                                               false, false, VPAD_BUTTON_LEFT));
                break;
            case BTN_DRIGHT:
                mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_DRIGHT,
    ...
    switch (wiiuIndexMapping->GetExtensionType()) {
        case WPAD_EXT_PRO_CONTROLLER:
            switch (bitmask) {
                case BTN_A:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_A,
                                                                                   false, false, WPAD_PRO_BUTTON_A));
                    break;
                case BTN_B:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_B,
                                                                                   false, false, WPAD_PRO_BUTTON_B));
                    break;
                case BTN_L:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_L,
                                                                                   false, false, WPAD_PRO_TRIGGER_L));
                    break;
                case BTN_R:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_R,
                                                                                   false, false, WPAD_PRO_TRIGGER_ZR));
                    break;
                case BTN_Z:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_Z,
                                                                                   false, false, WPAD_PRO_TRIGGER_ZL));
                    break;
                case BTN_START:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_START, false, false, WPAD_PRO_BUTTON_PLUS));
                    break;
                case BTN_CUP:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CUP, false, false, WPAD_PRO_STICK_R_EMULATION_UP));
                    break;
                case BTN_CDOWN:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CDOWN, false, false, WPAD_PRO_STICK_R_EMULATION_DOWN));
                    break;
                case BTN_CLEFT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CLEFT, false, false, WPAD_PRO_STICK_R_EMULATION_LEFT));
                    break;
                case BTN_CRIGHT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CRIGHT, false, false, WPAD_PRO_STICK_R_EMULATION_RIGHT));
                    break;
                case BTN_DUP:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_DUP,
                ...
                case BTN_DDOWN:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DDOWN, false, false, WPAD_PRO_BUTTON_DOWN));
                    break;
                case BTN_DLEFT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DLEFT, false, false, WPAD_PRO_BUTTON_LEFT));
                    break;
                case BTN_DRIGHT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DRIGHT, false, false, WPAD_PRO_BUTTON_RIGHT));
                    break;
            }
            return mappings;
        ...
        case WPAD_EXT_MPLUS_CLASSIC:
            switch (bitmask) {
                ...
                case BTN_R:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_R, false, true, WPAD_CLASSIC_BUTTON_ZR));
                    break;
                case BTN_Z:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_Z, false, true, WPAD_CLASSIC_BUTTON_ZL));
                    break;
                case BTN_START:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_START, false, true, WPAD_CLASSIC_BUTTON_PLUS));
                    break;
                case BTN_CUP:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CUP, false, true, WPAD_CLASSIC_STICK_R_EMULATION_UP));
                    break;
                case BTN_CDOWN:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CDOWN, false, true, WPAD_CLASSIC_STICK_R_EMULATION_DOWN));
                    break;
                case BTN_CLEFT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CLEFT, false, true, WPAD_CLASSIC_STICK_R_EMULATION_LEFT));
                    break;
                case BTN_CRIGHT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CRIGHT, false, true, WPAD_CLASSIC_STICK_R_EMULATION_RIGHT));
                    break;
                case BTN_DUP:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DUP, false, true, WPAD_CLASSIC_BUTTON_UP));
                    break;
                case BTN_DDOWN:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DDOWN, false, true, WPAD_CLASSIC_BUTTON_DOWN));
                    break;
                case BTN_DLEFT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DLEFT, false, true, WPAD_CLASSIC_BUTTON_LEFT));
                    break;
                case BTN_DRIGHT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DRIGHT, false, true, WPAD_CLASSIC_BUTTON_RIGHT));
                    break;
            }
            return mappings;
        ...
        case WPAD_EXT_MPLUS_NUNCHUK:
            switch (bitmask) {
                ...
                case BTN_Z:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_Z, false, false, WPAD_NUNCHUK_BUTTON_Z));
                    break;
                case BTN_START:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_START, false, false, WPAD_BUTTON_PLUS));
                    break;
                case BTN_CUP:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, BTN_CUP,
                                                                                   false, false, WPAD_BUTTON_UP));
                    break;
                case BTN_CDOWN:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CDOWN, false, false, WPAD_BUTTON_DOWN));
                    break;
                case BTN_CLEFT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CLEFT, false, false, WPAD_BUTTON_LEFT));
                    break;
                case BTN_CRIGHT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_CRIGHT, false, false, WPAD_BUTTON_RIGHT));
                    break;
            }
            return mappings;
        case WPAD_EXT_MPLUS:
        case WPAD_EXT_CORE:
            switch (bitmask) {
                ...
                case BTN_DDOWN:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DDOWN, false, false, WPAD_BUTTON_DOWN));
                    break;
                case BTN_DLEFT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DLEFT, false, false, WPAD_BUTTON_LEFT));
                    break;
                case BTN_DRIGHT:
                    mappings.push_back(std::make_shared<WiiUButtonToButtonMapping>(
                        shipDeviceIndex, portIndex, BTN_DRIGHT, false, false, WPAD_BUTTON_RIGHT));
                    break;
            }
            return mappings;
        default:
    ...
    for (auto [shipDeviceIndex, indexMapping] :
        ...
        if (wiiuIndexMapping->IsWiiUGamepad()) {
            ...
            for (uint32_t i = VPAD_BUTTON_SYNC; i <= VPAD_STICK_L_EMULATION_LEFT; i <<= 1) {
                ...
                return std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, bitmask, false, false,
                                                                   i);
            }
        ...
        switch (wiiuIndexMapping->GetExtensionType()) {
            ...
            case WPAD_EXT_MPLUS_NUNCHUK:
                for (auto i : { WPAD_NUNCHUK_STICK_EMULATION_LEFT, WPAD_NUNCHUK_STICK_EMULATION_RIGHT,
                    ...
                    return std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, bitmask, true, false,
                                                                       i);
                }
                break;
            case WPAD_EXT_CLASSIC:
            case WPAD_EXT_MPLUS_CLASSIC:
                for (uint32_t i = WPAD_CLASSIC_BUTTON_UP; i <= WPAD_CLASSIC_STICK_R_EMULATION_UP; i <<= 1) {
                    ...
                    return std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, bitmask, false, true,
                                                                       i);
                }
                break;
        }
        ...
        for (auto i : { WPAD_BUTTON_LEFT, WPAD_BUTTON_RIGHT, WPAD_BUTTON_DOWN, WPAD_BUTTON_UP, WPAD_BUTTON_PLUS,
            ...
            return std::make_shared<WiiUButtonToButtonMapping>(shipDeviceIndex, portIndex, bitmask, false, false, i);
        }
    }
